...
// var minispin = require('/minispin');
var randHex = require('g11n-pipeline/test/lib/randhex');
var gpTest = require ('g11n-pipeline/test/lib/gp-test');
// var GaasHmac = require('../lib/gp-hmac');
const Cli = require('../lib/gpcli');

var GP = require('g11n-pipeline'); // required, below
var client;
